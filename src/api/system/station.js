...
export function getStationCapacityList(query) {
  return request({
    url: '/system/sysPowerStationNetCapacity/getStationCapacityList',
    method: 'get',
    params: query
  })
}
...
export function getCapacityListAdd(data) {
  return request({
    url: '/system/sysPowerStationNetCapacity/createStationCapacity',
    method: 'post',
    data: data
  })
}
...
export function getCapacityListDelete(id) {
  return request({
    url: '/system/sysPowerStationNetCapacity/deleteStationCapacityById/' + id,
    method: 'post',
  })
}
//编辑装机容量
export function getCapacityListUpdate(data) {
  return request({
    url: '/system/sysPowerStationNetCapacity/updateStationCapacity',
    method: 'post',
    data: data
  })
}
