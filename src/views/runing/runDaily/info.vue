            ...
            <div class="table">
                <table class="tableInfo" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><span>{{ Number(reportDetail.faultLoss) + Number(reportDetail.notFaultLoss) }}</span></td>
                    </tr>
                    <tr>
...
<!--                        <td colspan="5" style="padding: 25px 25px;text-align:left;word-wrap: break-word;word-break: break-all;white-space: none;"><span>{{ reportDetail.remark }}</span></td>-->
<!--                    </tr>-->
                </table>
                <el-row>
                    <el-col :span="24">
...
<script>
import { detailDay } from "@/api/runing/runDaily/runDaily";
import { getSolarDayDataDetail } from "@/api/runing/OperationDayData";
import {
    getInspection,
...
export default {
    ...
    created() {
        ...
        this.getIndex(this.row);
        //巡检
        this.queryParams.params.beginTime = calendar;
        this.queryParams.params.endTime = calendar;
        this.getInspection();
        //工单
        this.gdquery.startTime = calendar;
        this.gdquery.endTime = calendar;
        //项目
        this.xmquery.createTime = calendar;
    ...
    methods: {
        ...
        //月数据和年数据
        getIndex(id) {
            getSolarDayDataDetail(id).then((res) => {
