<template>
    <div>
        <el-select v-model="checkList" multiple collapse-tags placeholder="请选择电站" @change="onChange">
            <el-option v-for="item in $store.getters.stationList" :key="item.stationId" :label="item.stationName" :value="item.stationId">
            </el-option>
        </el-select>
