<template>
    <div class="inverterHome flex flex-1 flex-v">
        <div class="flex-1 flex-v flex inverterStatus">
                ...
                <div class="flex-1 flex status">
                    <div class="flex-1 flex flex-v flex-pack-justify" style="padding:1rem">
                        ...
                        <div>
                            ...
                            <el-progress style="font-size:0.5rem" :percentage="data && data.faultShutNum ? (data.faultShutNum / data.inverterUnitList.length) * 100 : 0" :stroke-width="12" color="#00f416" :text-inside="true"></el-progress>
                        </div>
                    </div>
                    <div class="flex-1 flex flex-v flex-pack-justify" style="padding:1rem">
                        <div>
                            ...
                            <el-progress style="font-size:0.5rem" :percentage="data && data.warnRunNUm ? (data.warnRunNUm / data.inverterUnitList.length) * 100 : 0" :stroke-width="12" color="#00f416" :text-inside="true"></el-progress>
                        </div>
                        <div>
                            <div class="flex flex-pack-justify">
                        ...
                        <div>
                            ...
                            <el-progress style="font-size:0.5rem" :percentage="data && data.communiFaultNum ? (data.communiFaultNum / data.inverterUnitList.length) * 100 : 0" :stroke-width="12" color="#00f416" :text-inside="true"></el-progress>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex-1 flex-v flex inverter">
            <div class="inverterTitle">逆变器单元数据</div>
            <div class="flex-1 inverterIndex flex ">
                                            ...
                                            <el-col :span="12" class="flex flex-1 flex-v flex-pack-around">
                                                ...
                                                <el-col :span="24" class="flex">
                                                    <div class="flex flex-1 flex-pack-around flex-align-center">
                                                        ...
                                                        <span class="indexUnit flex-2">{{item.efficiency}}</span>
