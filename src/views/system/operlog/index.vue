...
export default {
  ...
  created() {
    this.getList();
    getdictList("sys_oper_type").then(response => {
  ...
  methods: {
    ...
    statusFormat(row, column) {
      console.log("----",this.selectDictLabel(this.statusOptions, row.status))
      return this.selectDictLabel(this.statusOptions, row.status);
    },
    // 操作日志类型字典翻译
    typeFormat(row, column) {
      // console.log("----",this.selectDictLabel(this.typeOptions, row.businessType))
