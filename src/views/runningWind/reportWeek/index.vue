<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['runningWind:reportWeek:export']">导出</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="list">
            ...
            <el-table-column label="风机总发电量(万kWh)" prop="weekWFanTotalKwh" :show-overflow-tooltip="true" width="200">
                <template slot-scope="scope">
                    <span>{{ scope.row.weekWFanTotalKwh.toFixed(2)}}</span>
                </template>
            </el-table-column>
            <el-table-column label="集电线总发电量(万kWh)" prop="weekWLineTotalKwh" :show-overflow-tooltip="true" width="200">
                <template slot-scope="scope">
                    <span>{{ scope.row.weekWLineTotalKwh.toFixed(2)}}</span>
                </template>
            </el-table-column>
            <el-table-column label="月厂用电率(%)" prop="monthWFactoryUsePercent" :show-overflow-tooltip="true" width="200">
                <template slot-scope="scope">
                    <span>{{ scope.row.monthWFactoryUsePercent.toFixed(2) + "%"}}</span>
                </template>
            </el-table-column>
            <el-table-column label="日平均风速(m/s)" prop="weekWDayRealAvgWind" :show-overflow-tooltip="true" width="200">
                <template slot-scope="scope">
                    <span>{{ scope.row.weekWDayRealAvgWind.toFixed(2)}}</span>
                </template>
            </el-table-column>
