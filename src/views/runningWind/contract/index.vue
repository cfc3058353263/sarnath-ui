    ...
    <div class="app-container">
        <el-form ref="form" :model="form" :inline="true" :rules="rules">
            <el-form-item prop="startTime" label="开始时间">
                <el-date-picker v-model="form.startTime" @change="changeStart" size="small" style="margin-right:10px;width:150px">
                </el-date-picker>
            </el-form-item>
            <el-form-item prop="endTime" label="结束时间">
                <el-date-picker v-model="form.endTime" size="small" :picker-options="endTime" style="width:150px">
                </el-date-picker>
            </el-form-item>
            <el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd()" v-hasPermi="['runningWind:runPlan:add']">新增合同</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="list">
            ...
            <el-table-column label="预计年平均风速(Wh/㎡)" prop="wWindAvgYear" :show-overflow-tooltip="true" />
...
export default {
    ...
    methods: {
        ...
        handleAdd() {
            this.$router.push({
                path: this.$store.getters.routerPrefix + '/runningWind/contract/PlanMonthWind',
                // name: "PlanMonthWind",
            });
        },
        //编辑
        handleUpdate(row) {
            this.$router.push({
                path: this.$store.getters.routerPrefix + '/runningWind/contract/MonthUpdate',
                query: {
                    id: row.id,
                },
            });
