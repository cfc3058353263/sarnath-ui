<template>
    <div class="app-container">
        <div class="info">
            ...
            <div class="table">
                <el-row class="rowStyle">
                    ...
                    <el-col class="labelStyle" :span="18"><span>{{row.buykWh}}</span></el-col>
                    <!--  -->
                    <el-col class="labelStyle" :span="2">4</el-col>
                    <el-col class="labelStyle" :span="4">厂用电量</el-col>
                    <el-col class="labelStyle" :span="18"><span>{{row.wMonthFactoryUseKwh}}</span></el-col>
                    <!--  -->
                    ...
                    <el-col class="labelStyle" :span="4">单台风机平均发电量</el-col>
                    <el-col class="labelStyle" :span="18"><span>{{row.wKwhPerFan}}</span></el-col>
                    <!--  -->
        ...
        <el-table :data="tableList" style="width: 100%">
            ...
            <el-table-column align="center" prop="dayKwh" label="发电量（kWh）"></el-table-column>
            <el-table-column align="center" prop="wKwhPerFan" label="单台风机平均发电量"></el-table-column>
            <el-table-column align="center" prop="wAvgWind" label="平均风速"></el-table-column>
            <el-table-column align="center" prop="wBuyNetKwh" label="下网电量"></el-table-column>
            <el-table-column align="center" prop="wDayFactoryUseKwh" label="厂用电量"></el-table-column>
            <el-table-column align="center" prop="wFactoryUsePercent" label="厂用电率"></el-table-column>
        </el-table>
        <pagination :auto-scroll="false" v-show="tabletotal > -1" :total="tabletotal" :page.sync="queryForm.pageNum" :limit.sync="queryForm.pageSize" @pagination="getDayList" :page-sizes="[7]" />
...
export default {
    ...
    created() {
        ...
        //赋值
        // this.queryForm.dateTime = this.row.calendar;
        // this.queryForm.contractId = this.row.contractId;
        // this.queryForm.stationIdList = [this.row.stationId]
        this.queryForm = {
        ...
        this.queryParams.params.endTime = this.moment(this.row.calendar)
            ...
            .format("YYYY-MM-DD");
        //工单
        this.gdquery.createTime = this.row.calendar;
    ...
    methods: {
         ...
         */
        getDayList() {
            getDayDataList(this.queryForm).then((res) => {
